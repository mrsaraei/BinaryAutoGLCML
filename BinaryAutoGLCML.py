...
print("Project: BinaryAutoGLCML: Automatic Comparative Machine Learning Based on GLCM for Machine Learning Models")
...
ROC_AUC = [roc_auc_score(t_test, t_pred0_prob[:, 1]),
           roc_auc_score(t_test, t_pred1_prob[:, 1]),
           roc_auc_score(t_test, t_pred2_prob[:, 1]),
           roc_auc_score(t_test, t_pred3_prob[:, 1]),               
           roc_auc_score(t_test, t_pred4_prob[:, 1]),
           roc_auc_score(t_test, t_pred5_prob[:, 1]),
           roc_auc_score(t_test, t_pred6_prob[:, 1]),
           roc_auc_score(t_test, t_pred7_prob[:, 1]),
           roc_auc_score(t_test, t_pred8_prob[:, 1]),               
           roc_auc_score(t_test, t_pred9_prob[:, 1]),
           roc_auc_score(t_test, t_pred10_prob[:, 1]),
           roc_auc_score(t_test, t_pred11_prob[:, 1])]
...
df_CML.to_csv('Binary_AutoGLCML.csv', index = False)
print("")
